...
?>
	...
	<footer id="site-footer" class="site-footer fondo-verde footer-hartridge">
		<div class="container">
            <div class="flex flex-row md:flex-col justify-between mb-4 gap-6 md:gap-8">
                <div class="col w-full md:w-auto">
                    <?php
                    $footer_logo = carbon_get_post_meta( get_the_ID(), 'crb_footer_logo' );
                    if ( $footer_logo ) {
                ...
                <div class="col w-full md:w-auto">                    
                    ...
                    <?php wp_nav_menu( array( 'menu' => 'hartridge' ) ); ?>
                </div>
                <div class="col w-full md:w-auto">
            ...
            <div class="flex flex-row justify-center items-center mb-4 derechos-reservados">
                <div class="col"><?php echo esc_html( carbon_get_post_meta( get_the_ID(), 'crb_hartridge_footer_copyright' ) ); ?></div>
            </div>
		</div>
	</footer>
